...
class CreateComment(CanCreateMixin, CommentCreateMixin):
    ...
    def form_valid(self, form):
        ...
        if author_email:
            email = EmailMessage(  
                "comment", 
                f'Hi someone left for you a comment you can see it on {reverse("blog:Details",kwargs={"slug":article.slug})}',
                to=[author_email]  
            )   
            print(reverse("blog:Details",kwargs={"slug":article.slug})+"......................................")
            email.send()

        if user_email:
            email = EmailMessage(  
                "comment", 
                f'Hi someone reply you can see it on {current_site}{reverse("blog:Details",kwargs={"slug":article.slug})}',
                to=[author_email]  
            )   
            email.send()
