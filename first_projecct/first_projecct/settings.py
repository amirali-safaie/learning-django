"""
Django settings for first_projecct project.
...
SECRET_KEY = 'django-insecure-rbg$!^jslmp(=+2+b05=362io#otz7$cp&hcy3e4+e6_@&*+!+'
...
INSTALLED_APPS = [    #لیست اپ های پروژه 
...
ROOT_URLCONF = 'first_projecct.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'templates')],       # دادن آدرس تمپلت های بیرون از اپ ها برای استفاده در ویو ها             
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'first_projecct.wsgi.application'
...
STATIC_URL = 'static/'
# STATIC_ROOT = os.path.join(BASE_DIR,'static') #روت فایل های استاتیک
STATICFILES_DIRS = [
    BASE_DIR / "static"
]
